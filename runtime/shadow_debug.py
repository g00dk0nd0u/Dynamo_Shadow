...
def _contour_preview_summary(value):
    ...
    return _sanitize_for_debug({
        ...
        "active_view_graphical_override": value.get("active_view_graphical_override"),
...
def _site_result_preview_debug_summary(v):
    ...
    return _sanitize_for_debug({
        ...
        "active_view_graphical_override": v.get("active_view_graphical_override"),
...
def _summarize_out_for_debug(out_payload):
    ...
    return {
        ...
        "performance_diagnostics": _sanitize_for_debug(out_payload.get("performance_diagnostics")),
