...
SETTINGS_POLICY = {
    ...
    "level_used_as_average_ground_level": True,
...
MEASUREMENT_PLANE_POLICY = {
    ...
    "average_ground_level_source": "selected_revit_level_then_settings_fallback",
    "measurement_height_source": "settings.measurement_height_m",
    "revit_level_used_as_average_ground_level": True,
